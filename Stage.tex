...
\newpage
    ...
    Une fois les structures étudiées et maitrisées, un premier convertisseur VTK-AMR vers SVDAG/SSVDAG sera à
...
\section{Travail réalisé}
    ...
    \begin{figure}[H]
        \centering{
        \resizebox{100mm}{!}{\includegraphics{ressources/images/slide_visu.png}}
        \label{slide_visu}
        }
    \end{figure}
