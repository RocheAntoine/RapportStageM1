...
\section{Travail réalisé}
    ...
    De plus, les restrictions de l'entreprises nous empêchent d'utiliser curl et wget comme bon nous semble, il a donc fallu créer des miroirs.
    ...
    Durant le reste du stage, mon travail consistera dans un premier temps à maitriser la structure VTK-AMR afin de faire un convertisseur AMR
    vers SVDAG. Ensuite, des rendus seront faits à partir de données AMR afin d'évaluer les performances et les améliorations possibles.
